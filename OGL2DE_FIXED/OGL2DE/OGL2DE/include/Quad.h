...
class Quad 
{
	...
	protected:
		...
		/* Shader IDs */
		GLuint m_MatrixID; // Location of MVP Matrix in Vertex Shader
		GLuint m_TextureID; // Location of Texture in Vertex Shader
		GLuint m_UVOffsetID; // Location of UV Offset in Vertex Shader
