...
class Sprite : public Quad
{
	public:
		...
		Sprite( const char* a_TexFilepath, int a_iWidth, int a_iHeight, int a_iTexWidth, int a_iTexHeight, int a_iFrameWidth, int a_iFrameHeight, GLFWwindow * a_opWindow);
		~Sprite();
		void Draw();
		void Cleanup();
